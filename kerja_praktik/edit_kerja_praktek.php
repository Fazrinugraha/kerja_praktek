...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM kerja_praktek WHERE id = ?";
...
<head>
    ...
    <title>Edit Data Kerja Praktek</title>
...
<body>
    <div class="container">
        <h2>Edit Data Kerja Praktek</h2>
        <form action="update_kerja_praktek.php" method="post" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nim" name="nim" value="<?php echo htmlspecialchars($row['nim']); ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="angkatan" name="angkatan" value="<?php echo htmlspecialchars($row['angkatan']); ?>" required>
            </div>
            <div class="form-group">
                <label for="tempat_magang">Tempat Magang:</label>
                <input type="text" class="form-control" id="tempat_magang" name="tempat_magang" value="<?php echo htmlspecialchars($row['tempat_magang']); ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pembimbing1" name="pembimbing1" value="<?php echo htmlspecialchars($row['pembimbing1']); ?>">
            </div>
            <div class="form-group">
                <label for="pembimbing2">Pembimbing 2:</label>
                <input type="text" class="form-control" id="pembimbing2" name="pembimbing2" value="<?php echo htmlspecialchars($row['pembimbing2']); ?>">
            </div>
